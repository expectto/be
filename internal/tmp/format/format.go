// Package format is a copy of "gomega/format" package for now:
// Later we switch to a custom-written one.
//
// Reference: https://github.com/onsi/gomega/blob/master/format/format.go
package format
